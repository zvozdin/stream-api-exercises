...
//        List<User> users = User.getUsersWithAge(10, 20, 30);
//        assertTrue(Stream8.anyMatch(users, 20));
//    }
//
//    @Test
...
//        numberStream = Stream.empty();
//        numberStream = Stream.of(new Integer[10]);
//        numberStream = Stream.of(new Integer(10), new Integer(10));
//        assertNotNull(numberStream);
//        assertNotNull(Stream.of());
//    }
//
////    @Test
